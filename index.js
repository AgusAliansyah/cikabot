...
/******** OWNER NUMBER**********/
const ownerNumber = ["62895603272884@s.whatsapp.net","62895603272884@s.whatsapp.net"] 
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('qr already scan. Follow','white'),color('INSTA','red'),color('GRAM','white'),color('@agus_alnsyh','yellow'))
})
